  ...
  const fetchTrainerDetails = async (id) => {
    try {
      const response = await axios.get(
        `http://localhost:3000/api/trainer/details/${id}`
      );
...
//this is for khaltii
  const handleKhalti = async () => {
    ...
    try {
      ...
      console.log(
        "Successfully saved booking details to localStorage:",
        bookingDetails
      );
    } catch (error) {
        ...
        <main className="flex-1 p-8">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold">
              Welcome back,{" "}
              {trainerDetails ? trainerDetails.userName : "Trainer"}!
            </h2>
                ...
                <div className="mt-4 space-y-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">
                      {trainerDetails ? trainerDetails.userName : "Alish Ban"}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-gray-500">
                    ...
                    <span>
                      {trainerDetails
                        ? trainerDetails.location
                        : "Itahari-3, Bhetghat Chowk"}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-gray-500">
                    <Mail size={20} />
              ...
              <div className="grid grid-cols-2 gap-8 mt-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <p className="font-medium">
                      {trainerDetails
                        ? trainerDetails.yearsOfExperience + " Years"
                        : "5 Years"}
                    </p>
                  </div>
                  <div className="flex space-x-2">
                ...
                <div className="bg-white shadow-md rounded-xl border border-gray-100 overflow-hidden">
                  <div className="bg-red-50 px-4 py-3 flex items-center space-x-3">
                    ...
                    <p className="text-sm font-semibold text-red-600">
                      Available:{" "}
                      {trainerDetails
                        ? trainerDetails.availabilityHours
                        : "Evening"}
                    </p>
                  </div>
                  <div className="px-4 py-3 flex items-center space-x-3">
                    ...
                    <p className="text-sm text-gray-600">
                      {trainerDetails
                        ? trainerDetails.startDay +
                          " - " +
                          trainerDetails.endDay
                        : "Sunday - Friday"}
                    </p>
                  </div>
                </div>
